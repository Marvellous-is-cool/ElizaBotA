...
class Bot(BaseBot):
    def __init__(self):
        ...
        self.pickup_lines = [
            "Happy birthday to the most beautiful soul in the room! 💕",
            "Every moment with you feels like a celebration, especially today! 🎉",
            "You're not just aging, you're becoming more gorgeous with each year! ✨",
            "Today isn't just your birthday, it's the anniversary of when the world became more beautiful! 💖",
            "If I could give you one gift, it would be to see yourself through my eyes! 👀💕",
            "You're the reason my heart skips a beat, birthday girl! 💓",
            "Another year older, another year of being absolutely stunning! 🌟",
            "Your smile lights up this room more than all the birthday candles! 🕯️✨",
            "I fall in love with you more every day, especially on your special day! 💘",
            "You're not just a year older, you're a year more amazing! 🎂💕",
            "Happy birthday to my favorite person in the entire universe! 🌍💖",
            "You make every day feel like a celebration, but today is extra special! 🎊",
            "Your beauty outshines all the birthday decorations! 🎈✨",
            "I'm so lucky to celebrate another year of your wonderful existence! 🍀💕",
            "Beautiful is what they call a beautiful woman, but I am short of words to use in describing you, beauty is an understatement! 🍷💖"
